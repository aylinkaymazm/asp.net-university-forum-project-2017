    ...
    <table border="1" background="fondwallpapertx1.jpg" width="500px" height="800px" align="center" cellpadding="20px">
      ...
      <tr>
        ...
        <td width="750px" height="980px" border="1px" cellpadding="20px" cellspacing="20px">
          ...
          <table width="800px">
            <font size="20px" font face="Georgia" color="Purple"><b>Elif Tezcanolur</b></font><br><br>
            <img src="IMG-20170312-WA0106.jpg" width="500px" height="450px" /><br><br>
            <td>
              <table border="0" width="400">
                ...
                %>
                    ...
                    <div class="kutu">
                      <center>
                        <form action="VeriGirisiKisi.asp" method="post">
